...
app.get('/back', (req, res) => {
  ...
  var all_url='https://api.tomorrow.io/v4/timelines?location='+location_pair+'&fields='+field_all+'&timesteps=current,1h,1d&units=imperial&timezone=America/Los_Angeles&apikey='+skey
  console.log(all_url);
